...
namespace mlang {
    ...
    CodeStatement*
    CodeIterationStatement::increment_statement() {
        return this->m_increment_statement;
    }

    CodeStatement*
    CodeIterationStatement::init_statement() {
        return this->m_init_statement;
    }

    CodeStatementCollection*
    CodeIterationStatement::statements() {
        return this->m_statements;
    }
    
    void
    CodeIterationStatement::increment_statement(CodeStatement* value) {
        this->m_increment_statement = value;
    }

    void
    CodeIterationStatement::init_statement(CodeStatement* value) {
        this->m_init_statement = value;
    }
    
    CodeExpression*
    CodeIterationStatement::test_expression() {
        return this->m_test_expression;
    }

    void
    CodeIterationStatement::test_expression(CodeExpression* value) {
        this->m_test_expression = value;
    }
    
    bool CodeIterationStatement::type_of(CodeObjectKind kind) {
        return kind == CodeObjectKind::CodeIterationStatement || CodeStatement::type_of(kind);
    }
    
    void 
    CodeIterationStatement::scope(CodeScope* scope) {
