...
namespace mlang {
    ...
    void
    CodeAssignExpression::left(CodeExpression* value) {
        this->m_left = value;
    }
    
    CodeExpression* 
    CodeAssignExpression::left() {
        return this->m_left;
    }
    
    void 
    CodeAssignExpression::right(CodeExpression* value) {
        this->m_right = value;
    }
        
    CodeExpression* 
    CodeAssignExpression::right() {
        return this->m_right;
    }
    
    void 
    CodeAssignExpression::scope(CodeScope* scope) {
    ...
    bool CodeAssignExpression::type_of(CodeObjectKind kind) {
        return kind == CodeObjectKind::CodeAssignExpression || CodeExpression::type_of(kind);
    }
}
