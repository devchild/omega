...
namespace mlang {
    ...
    std::string
	CodeFieldReferenceExpression::field_name()  {
        return this->m_field_name;
    }

    void
	CodeFieldReferenceExpression::field_name(std::string name) {
        this->m_field_name = name;
    }

    CodeExpression*
	CodeFieldReferenceExpression::target_object()  {
        return this->m_target_object;
    }

    void
	CodeFieldReferenceExpression::target_object(CodeExpression* target_object) {
    ...
    bool CodeFieldReferenceExpression::type_of(CodeObjectKind kind) {
        return kind == CodeObjectKind::CodeFieldReferenceExpression || CodeExpression::type_of(kind);
    }

    void
	CodeFieldReferenceExpression::scope(CodeScope* scope) {
