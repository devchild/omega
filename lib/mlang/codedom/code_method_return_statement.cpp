...
namespace mlang {
    ...
    void 
    CodeMethodReturnStatement::expression(CodeExpression* value) {
        this->m_expression = value;
    }

    CodeExpression*
    CodeMethodReturnStatement::expression() {
    ...
    bool CodeMethodReturnStatement::type_of(CodeObjectKind kind) {
        return kind ==  CodeObjectKind::CodeMethodReturnStatement || CodeStatement::type_of(kind);
    }
    
    void 
    CodeMethodReturnStatement::scope(CodeScope* scope) {
