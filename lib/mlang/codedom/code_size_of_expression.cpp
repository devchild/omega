...
namespace mlang {
    ...
    CodeTypeReference* CodeSizeOfExpression::type() {
        return this->m_type;
    }
    ...
    bool CodeSizeOfExpression::type_of(CodeObjectKind kind) {
        return kind == CodeObjectKind::CodeSizeOfExpression || CodeExpression::type_of(kind);
    }
    
    void 
	CodeSizeOfExpression::scope(CodeScope* scope) {
