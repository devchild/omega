...
namespace mlang {
    ...
    std::string CodeVariableDeclarationStatement::name() {
        return this->m_name;
    }
    ...
    bool CodeVariableDeclarationStatement::type_of(CodeObjectKind kind) {
        return kind == CodeObjectKind::CodeVariableDeclarationStatement || CodeStatement::type_of(kind);
    }

    void 
    CodeVariableDeclarationStatement::scope(CodeScope* scope) {
