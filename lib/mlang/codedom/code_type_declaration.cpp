...
std::string CodeTypeDeclaration::name() {
	return this->m_name;
}

void CodeTypeDeclaration::name(std::string value) {
	this->m_name = value;
}

bool CodeTypeDeclaration::is_class() {
	return this->m_is_class;
}

void CodeTypeDeclaration::is_class(bool value) {
	this->m_is_class = value;
}

bool CodeTypeDeclaration::is_embedded() {
	return this->m_is_embedded;
}
...
bool CodeTypeDeclaration::is_struct() {
	return this->m_is_struct;
}

void CodeTypeDeclaration::is_struct(bool value) {
