...
namespace mlang {
    ...
    std::string
    CodeTypeReference::base_type() {
        return this->m_base_type;
    }
    
    void
    CodeTypeReference::base_type(std::string value) {
    ...
    int CodeTypeReference::array_rank(){
    	return this->m_array_rank;
    }

    void CodeTypeReference::array_rank(int value){
    	this->m_array_rank = value;
    }
}
