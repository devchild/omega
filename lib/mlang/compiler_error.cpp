...
namespace mlang {
    ...
    void CompilerError::message(std::string message) {
        this->m_message = message;
    }

    std::string CompilerError::message() {
    ...
    bool 
    CompilerError::has_location() {
        return this->m_has_location;
    }
}
