...
void* CodePrimitiveExpression::value() { return this->m_value; }

void CodePrimitiveExpression::value(void* value) { this->m_value = value; }
...
CodeTypeReference* CodePrimitiveExpression::type() { return this->m_type; }

std::string CodePrimitiveExpression::value_as_string() {
