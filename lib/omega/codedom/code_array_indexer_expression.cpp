...
CodeArrayIndexerExpression::CodeArrayIndexerExpression() : CodeExpression() {
...
bool CodeArrayIndexerExpression::type_of(CodeObjectKind kind) {
  return kind == CodeObjectKind::CodeArrayIndexerExpression ||
         CodeExpression::type_of(kind);
}

void CodeArrayIndexerExpression::scope(CodeScope* scope) {
...
CodeExpressionCollection* CodeArrayIndexerExpression::indices() {
  return this->m_indices;
}

CodeExpression* CodeArrayIndexerExpression::target_object() {
  return this->m_target_object;
}

void CodeArrayIndexerExpression::target_object(CodeExpression* value) {
