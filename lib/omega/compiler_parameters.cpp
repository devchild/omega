...
void CompilerParameters::generate_executable(bool value) {
  this->m_generate_executable = value;
}

bool CompilerParameters::generate_executable() {
  return this->m_generate_executable;
}

void CompilerParameters::optimize(bool value) { this->m_optimize = value; }

bool CompilerParameters::optimize() { return this->m_optimize; }

void CompilerParameters::dump_ir(bool value) { this->m_dump_ir = value; }

bool CompilerParameters::dump_ir() { return this->m_dump_ir; }
...
list<string> *CompilerParameters::input_files() { return this->m_input_files; }
}
